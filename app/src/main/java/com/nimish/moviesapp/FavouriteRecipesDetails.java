...
public class FavouriteRecipesDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_favourite_recipes_details);
        ...
        recipeRef = database.collection("favourite").document(rid);
