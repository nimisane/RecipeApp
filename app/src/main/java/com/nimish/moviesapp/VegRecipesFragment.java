 ...
 * Use the {@link VegRecipesFragment#newInstance} factory method to
...
public class VegRecipesFragment extends Fragment {
     ...
     * @return A new instance of fragment VegRecipesFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static VegRecipesFragment newInstance(String param1, String param2) {
        VegRecipesFragment fragment = new VegRecipesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_veg_recipes, container, false);

        vegRecyclerview = rootView.findViewById(R.id.veg_recyclerview);
    ...
    private void loadRecipes() {
        ...
        recipeRef.orderBy("recipeName").whereEqualTo("recipeType","Veg").get()
