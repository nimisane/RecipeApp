 ...
 * Use the {@link NonVegRecipesFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class NonVegRecipesFragment extends Fragment {
     ...
     * @return A new instance of fragment NonVegRecipesFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static NonVegRecipesFragment newInstance(String param1, String param2) {
        NonVegRecipesFragment fragment = new NonVegRecipesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_non_veg_recipes, container, false);

        vegRecyclerview = rootView.findViewById(R.id.non_veg_recyclerview);
    ...
    private void loadRecipes() {
        ...
        recipeRef.orderBy("recipeName").whereEqualTo("recipeType","Non Veg").get()
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        vegRecyclerview.setAdapter(trendingRecipesAdapter);
